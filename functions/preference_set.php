...
class preference_set 
{
	...
	{
      return " isUser: ".$this->is_user." RFID: ".$this->rfid." ROOM: ".$this->room_id." SET: ".$this->set_id;
    }
    ...
    public function removeSet ()
    {
      ...
      $query = " DELETE FROM set_pref WHERE set_id='".$this->set_id."' ";
	...
	public function pullFromDatabase ()
	{
      ...
      $query = " SELECT * FROM set_pref WHERE set_id='".$this->set_id."' ";
      ...
      if ($this->is_user == 0)
      {
        $query = " SELECT * FROM rooms WHERE room_id='".$this->is_user."' ";
        $row = mysql_fetch_array ($res);
