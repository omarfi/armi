...
class preference {
	...
	private function getFieldsList($type) {
		...
		if ($type == 0)
			return
			    " pref_name, min_value, max_value, rfid, pref_id ";
	...
	private function getValuesList($type) {
		if ($type == 0)
			return "\"".$this->name."\", "."\"".$this->min_value.
			    "\", "."\"".$this->max_value."\", "."\"".$this->
			    rfid."\", "."\"".$this->id."\" ";

		return "\"".$this->id."\", "."\"".$this->rfid."\", "."\"".
		    $this->current_value."\", "."\"".$this->set_id."\" ";
    ...
    */
	public function __toString() {
		return "Name: ".$this->name."  ID: ".$this->id.
		    " CurrentValue: ".$this->current_value." MinValue:".$this->
		    min_value."  MaxValue:".$this->max_value."  RFID: ".$this->
		    rfid."  SetID: ".$this->set_id;
	}
    ...
    */
	public function addToDatabase($type) {
		...
		if ($type == 0)
			...
			$query. =
			    "(  pref_id, owner_rfid, current_value, set_id )";
    ...
    */
	...
	public function removeFromSet() {
		...
		$table = " modified_pref ";
		$where =
		    " set_id='".$this->set_id."' AND pref_id='".$this->id."' ";
	...
	public function modifyCurrentValue($value) {
		...
		$where =
		    " set_id='".$this->set_id."' AND pref_id='".$this->id."' ";
		$query =
		    "UPDATE modified_pref SET current_value='$value' WHERE $where";
		$conn = connectToDatabase();
